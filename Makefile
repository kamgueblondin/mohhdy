...
# GTK + COM2 + tablet : hit-test dock apres grow/shrink. Hors integration-qemu.
qemu-osui-gui-fit-input: $(OS_IMAGE) pack-initrd disk
	@python3 tests/scripts/test_qemu_gui_fit_input.py
