...
.PHONY: integration-qemu qemu-integration-plan qemu-irq0-preemption qemu-ai-provider qemu-ne2k-status qemu-ne2k-tls-http qemu-ne2k-tls-sse qemu-ne2k-tls-next qemu-ne2k-tls-multipair qemu-ps2-dual qemu-ne2k-shared-topology qemu-ne2k-tls-multi-guest qemu-ne2k-guest-app-traffic qemu-ne2k-guest-tls-peer qemu-ne2k-guest-tls-chat qemu-ne2k-guest-tls-server qemu-ne2k-guest-tls-appdata qemu-ne2k-guest-tls-chat-metier qemu-ipc-foundation qemu-vfs-service qemu-service-grant
...
# Not part of integration-qemu. Prerequisite for shared Ethernet topology.
...
# Suite tranche 2: ARP croise + SYN peer.local sur hub partage (hors ci).
qemu-ne2k-guest-app-traffic: $(OS_IMAGE) pack-initrd
	@python3 tests/scripts/test_qemu_ne2k_guest_app_traffic.py

# Suite guest-guest : B LISTEN + SYN-ACK invite (hors ci).
qemu-ne2k-guest-tls-peer: $(OS_IMAGE) pack-initrd
	@python3 tests/scripts/test_qemu_ne2k_guest_tls_peer.py
...
# Suite guest-guest : app data AES-GCM A->B puis echo B->A (hors ci).
qemu-ne2k-guest-tls-appdata: $(OS_IMAGE) pack-initrd
	@python3 tests/scripts/test_qemu_ne2k_guest_tls_appdata.py

# Suite guest-guest : chat metier AES-GCM bilaterale multi-messages (hors ci).
qemu-ne2k-guest-tls-chat-metier: $(OS_IMAGE) pack-initrd
	@python3 tests/scripts/test_qemu_ne2k_guest_tls_chat_metier.py
...
help:
	...
	@echo "  qemu-ne2k-guest-tls-appdata - Suite: ping/pong AES-GCM guest-guest (hors ci)"
	@echo "  qemu-ne2k-guest-tls-chat-metier - Suite: chat metier AES-GCM bilaterale (hors ci)"
