...
| 5 | Isolation reseau (worker `net-driver`) | Prototype guest | Slice 1 : gate -59 ; slice 2 : relais IPC des syscalls socket 99-108 vers le worker (codec TCP, pas d'emission NIC), LLM/peer toujours -59 ; pilote NE2000 et piles encore Ring 0. Suite : emission/reception de segments sur le fil reservee au worker |
