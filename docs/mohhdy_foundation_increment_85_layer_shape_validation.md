...
Le prochain lot pourra ajouter une fixture de matrices 2D GPT-2 et vérifier les relations `channels`, `3 x channels` et `4 x channels` avant de connecter la lecture FAT16 paginée au calcul quantifié.
