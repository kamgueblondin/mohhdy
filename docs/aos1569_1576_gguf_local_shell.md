...
| Runtime local | État statique GPT-2 12 x 768, cache KV de 64 positions et top-k déterministe | Zéro `kmalloc`, `malloc`, `calloc` ou `realloc`. |
...
| Cache KV | 12 x 64 x 2 x 768 floats | K/V persistants par couche pour le préfixe courant. |
