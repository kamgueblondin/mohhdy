...
|---|---|---|
| Projection MLP `ffn_down` | Le buffer de ligne était limité à trois blocs Q6_K, soit 630 octets. Une ligne `ffn_down` de largeur `4 x 768` nécessite jusqu'à 2 520 octets au format Q6_K. | Le buffer statique est dimensionné à partir de la largeur cachée maximale `4C` et du pire bloc Q6_K. |
