...
5. [PLAN_SE_MOHHDY_COMPLET.md](PLAN_SE_MOHHDY_COMPLET.md) - **roadmap produit** : catalogue des capacites, OS-UI-0..3, gates. Premieres tranches OS-UI-0/1/2 : [osui_0_1_2.md](osui_0_1_2.md), [osui_chat_desktop.md](osui_chat_desktop.md)
...
| [osui_chat_desktop.md](osui_chat_desktop.md) | Interaction : chat central, raccourcis slash, chat flottant draggable |
