...
Au montage du disque ATA, le noyau attache une fenêtre statique de `8 x 512` octets et l'adaptateur `ata_read_sectors()`. L'absence ou l'échec d'attache n'empêche pas le boot : le pilote FAT16 poursuit avec le lecteur mono-secteur déjà validé.
