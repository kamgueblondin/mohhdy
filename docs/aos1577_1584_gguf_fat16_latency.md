...
| Kernel Q6_K | Facteurs `d x scale` pré-calculés par segment de 128 valeurs | Les produits de la tête de logits et des matrices Q6_K évitent des multiplications répétées. |
