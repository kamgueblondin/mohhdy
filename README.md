...
- [x] Topologie Ethernet locale partagée (tranche 2) : `make qemu-ne2k-shared-topology` — hub `127.0.0.1`, deux NE2000 simultanés, nic×2, DHCP Discover A / B vivant ; TLS multi-invités simultané encore ouvert
