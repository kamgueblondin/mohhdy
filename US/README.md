...
| **Track Agent Support** | [mohhdy_agent_support_web.md](mohhdy_agent_support_web.md) | Spec `ASSIST-xxx`. ASSIST-050/010/011/040 = runtime HTTP (`agent/`) : embed, sessions, admin a jeton, echo stub. Actes navigateur **non livrés** |
...
| [mohhdy_agent_support_web.md](mohhdy_agent_support_web.md) | Track Agent Support (`ASSIST-xxx`) : embed, admin, droits de session, Docker / cloud. ASSIST-010/011/040 livrés (echo stub) ; reste spec |
