...
| **Track Agent Support** | [mohhdy_agent_support_web.md](mohhdy_agent_support_web.md) | Spec `ASSIST-xxx`. ASSIST-050/010/011/012/030/031/040/041 = runtime HTTP (`agent/`) : embed, sessions, KB, droits, escalade, handoff, admin a jeton, stub local. Actes navigateur **non livrés** |
...
| [mohhdy_agent_support_web.md](mohhdy_agent_support_web.md) | Track Agent Support (`ASSIST-xxx`) : embed, admin, droits de session, Docker / cloud. ASSIST-010/011/012/030/031/040/041 livrés (stub local) ; actes navigateur restent spec |
